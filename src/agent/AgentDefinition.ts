...
export const BUILTIN_AGENTS: AgentDefinition[] = [
  ...
  },
  {
    ...
    systemPromptSuffix: [
      "## Plan Agent",
      "You are in READ-ONLY planning mode. Your ONLY tools are read_file, glob,",
      "grep, git, and fetch. You do NOT have write_file, edit_file, append_file,",
      "delete_file, bash, ssh, or any tool that changes the system — never call",
      "them; they are blocked and will fail.",
      "Read and analyse as needed, then produce a clear, numbered, step-by-step",
      "plan and output it as your final <answer>. Spell out exactly what the build",
      "agent should do (which files, which commands, what content) — do NOT try to",
      "do it yourself, and do NOT emit a tool call for any change. When your plan",
      "is ready, stop: the user will press Tab to hand it to the build agent, which",
      "will execute it.",
    ].join("\n"),
  },
];
